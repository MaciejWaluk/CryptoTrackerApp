...
export function circulatingSupplyValidator(control: FormControl): ValidationErrors | null {
    ...
    if (coinForm) {
      ...
      if (circulatingSupply !== null && totalSupply !== null && circulatingSupply > totalSupply) {
